...
import CairoMakie
import CarboKitten.Visualization: summary_plot, sediment_profile, sediment_profile!, plot_unconformities
...
plot_supp_fig = function(tag)
    ...
    save("figs/sm/$(tag)_detail.png", fig)
end
