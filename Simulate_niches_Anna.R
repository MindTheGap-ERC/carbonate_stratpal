...
#Created using chatgpt,perplexity, and the help of my supervisors Niklas Hohmann and Emilia Jarochowska 
...
optima <- -4.10 + (42.44 + 4.10) * (uniform_seq)^2  # Quadratic: more values near 0
...
max_width <- 15  # Widest at deepest depth
